...
export default function Footer() {
  return (
    <footer className="bg-dark-gray text-cream-white">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="text-cream-white/60 hover:text-champagne-gold transition-colors"
