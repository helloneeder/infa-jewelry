...
export const mockProducts: Product[] = [
  {
    ...
    category: 'necklaces',
    description: '以星辰為靈感，鑲嵌細緻鋯石，在光線下閃耀迷人光芒。',
    details: ['925 純銀鍍 14K 金', '鋯石鑲嵌', '鏈長 40cm + 5cm 延長鏈', '附品牌包裝盒'],
    material: '925 純銀',
    isNew: true,
    stock: 15,
  },
  {
    ...
    category: 'bracelets',
    description: '精選天然淡水珍珠，手工串聯，呈現優雅氣質。',
    details: ['天然淡水珍珠', '925 純銀扣頭', '手圍 16cm + 3cm 延長鏈', '附品牌包裝盒'],
    material: '天然珍珠',
    isBestSeller: true,
    stock: 23,
  },
  {
    ...
    category: 'rings',
    description: '簡約線條設計，象徵永恆的愛情承諾。',
    details: ['925 純銀鍍 18K 金', '開口設計可微調', '寬度 2mm', '附品牌包裝盒'],
    material: '925 純銀',
    isBestSeller: true,
    stock: 8,
  },
  {
    ...
    category: 'earrings',
    description: '如清晨露珠般晶瑩剔透，為日常增添亮點。',
    details: ['925 純銀', '鋯石鑲嵌', '耳針式', '附品牌包裝盒'],
    material: '925 純銀',
    isNew: true,
    stock: 30,
  },
  {
    ...
    category: 'necklaces',
    description: '大自然的饋贈，精緻葉脈紋路栩栩如生。',
    details: ['925 純銀', '鏈長 45cm + 5cm 延長鏈', '手工雕刻', '附品牌包裝盒'],
    material: '925 純銀',
    stock: 12,
  },
  {
    ...
    category: 'bracelets',
    description: '極細鍊條設計，適合單戴或堆疊佩戴。',
    details: ['925 純銀鍍 14K 金', '手圍 15cm + 3cm 延長鏈', '可調節長度', '附品牌包裝盒'],
    material: '925 純銀',
    stock: 18,
  },
  {
    ...
    category: 'rings',
    description: '滿天星設計，指尖的銀河系。',
    details: ['925 純銀', '開口設計', '手工打磨', '附品牌包裝盒'],
    material: '925 純銀',
    isNew: true,
    stock: 20,
  },
  {
    ...
    category: 'earrings',
    description: '立體花瓣造型，柔美動人。',
    details: ['925 純銀', '耳針式', '手工塑形', '附品牌包裝盒'],
    material: '925 純銀',
    isBestSeller: true,
    stock: 15,
  },
